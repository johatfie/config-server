node {
    ...
    stage('Kubernetes deploy') {
        ...
        //withKubeConfig(caCertificate: '', clusterName: 'arn:aws:eks:us-east-2:326608040956:cluster/widgets-are-us', contextName: 'arn:aws:eks:us-east-2:326608040956:cluster/widgets-are-us', credentialsId: 'kubeconfig_file_2', namespace: '', serverUrl: 'https://84B31EEEAB9245573293B5C2AE2612D5.yl4.us-east-2.eks.amazonaws.com') {
            withKubeConfig(caCertificate: '', clusterName: '', contextName: '', credentialsId: 'kubeconfig_file_2', namespace: '', serverUrl: '') {
        // some block
            // some block
